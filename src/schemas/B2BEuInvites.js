...
// --- Begin: B2B Partner End Users Invitations Schema --- //
...
schema.index({delFlag: -1, b2b: 1, org: 1, team: 1, iStatus: 1});
schema.index({delFlag: -1, b2b: 1, pReports: 1, iStatus: 1, uDtStr: -1});
schema.index({cDtStr: -1, uDtStr: -1});

module.exports = mongoose.model(config.collB2BEuInvites, schema);
// --- End: B2B Partner End Users Invitations Schema --- //
