...
// --- Begin: B2B Partner End Users Invitations Educations Schema --- //
...
module.exports = mongoose.model(config.collB2BEuInvitesEds, schema);
// --- End: B2B Partner End Users Invitations Educations Schema --- //
