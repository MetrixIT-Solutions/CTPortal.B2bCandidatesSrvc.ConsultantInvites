...
// --- Begin: B2B Partner End Users Invitations Addresses Schema --- //
...
module.exports = mongoose.model(config.collB2BEuInvitesAdrs, schema);
// --- End: B2B Partner End Users Invitations Addresses Schema --- //
